...
public class MoocSchema {
    ...
    public static class Story {
        ...
        private final static String MIME_TYPE_END = "story";        // define the MIME type of data in the content provider
    ...
    public static class Tags {
        ...
        private final static String MIME_TYPE_END = "tags";        // define the MIME type of data in the content provider
