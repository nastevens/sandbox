...
public class MoocResolver {
     ...
     * Constructor
     *
     * @param activity The Activity to get the ContentResolver from.
     */
     ...
     * into a 'start state'
     *
     * @param data what is to be inserted into the ContentProvider
     ...
     *
     * @param storyObject object to be inserted
