...
public class CreateStoryActivity extends StoryActivityBase {
    ...
    private void launchSoundIntent() {
        ...
        Intent soundRecord = new Intent(this, SoundRecordActivity.class);
        ...
        soundRecord.putExtra(SoundRecordActivity.EXTRA_OUTPUT, soundFile.toString());


        // Start a new activity for result, using the new intent and the request
        // code MIC_SOUND_REQUEST
        startActivityForResult(soundRecord, MIC_SOUND_REQUEST);
    ...
    private void launchCameraIntent() {
        ...
        Intent launchMediaStore = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        ...
        launchMediaStore.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);


        // Start a new activity for result, using the new intent and the request
        // code CAMERA_PIC_REQUEST
        startActivityForResult(launchMediaStore, CAMERA_PIC_REQUEST);
    ...
    private void launchVideoCameraIntent() {
        ...
        // Hint: use standard Intent from MediaStore class
        // See: http://developer.android.com/reference/android/provider/MediaStore.html
        Intent launchVideoCapture = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
        ...
        // Add the filename to the Intent as an extra. Use the Intent-extra name
        // from the MediaStore class, EXTRA_OUTPUT
        launchVideoCapture.putExtra(MediaStore.EXTRA_OUTPUT, videoUri);
        ...
        launchVideoCapture.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 1);


        // Start a new activity for result, using the new intent and the request
        // code CAMERA_VIDEO_REQUEST
        startActivityForResult(launchVideoCapture, CAMERA_VIDEO_REQUEST);
