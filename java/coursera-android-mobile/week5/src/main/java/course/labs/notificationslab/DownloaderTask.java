		...
		mApplicationContext.sendOrderedBroadcast(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						// Check whether the result code is RESULT_OK. If so, don't send the notification.
						if (getResultCode() != Activity.RESULT_OK) {

							// If so, create a PendingIntent using the restartMainActivityIntent and set its flags
							...
							// Uses R.layout.custom_notification for the layout of the notification View. The xml
							// file is in res/layout/custom_notification.xml
							RemoteViews mContentView = new RemoteViews(mApplicationContext.getPackageName(),
									R.layout.custom_notification);

							// Set the notification View's text to reflect whether or the download completed successfully
                            if (success) {
							...
							// Use the Notification.Builder class to create the Notification. You will have to set
							// several pieces of information. You can use android.R.drawable.stat_sys_warning
