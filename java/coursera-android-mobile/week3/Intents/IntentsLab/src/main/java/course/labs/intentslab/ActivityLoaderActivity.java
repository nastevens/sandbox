...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
        ...
        Intent explicit = new Intent(this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		Intent chooserIntent = Intent.createChooser(uriIntent, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == GET_TEXT_REQUEST_CODE) {
            mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.RESULT_TEXT));
        }
