 ...
 */
public class ReqSentState extends PppState {

    private PppActions actions;

    public ReqSentState(StateMachine stateMachine, PppActions actions) {
        super(stateMachine, "Req-Sent");
