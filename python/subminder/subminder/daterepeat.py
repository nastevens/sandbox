...
# Mask day of the year to the month it is in (leap year)
M366MASK = tuple([1]*31+[2]*29+[3]*31+[4]*30+[5]*31+[6]*30+
                 [7]*31+[8]*31+[9]*30+[10]*31+[11]*30+[12]*31+[1]*7)
# Remove Feb 29
M365MASK = M366MASK[:59] + M366MASK[60:]
...
del M29, M30, M31, MDAY365MASK[59], NMDAY365MASK[31]
    ...
    def rebuild(self, year, month):
        ...
        if year != self.lastyear:
            ...
            if self.yearlen == 365:
                ...
                # Ingenious - creates a mask of weekdays for the whole year 
                # by chopping off everything before the weekday of the first
                # of the year
